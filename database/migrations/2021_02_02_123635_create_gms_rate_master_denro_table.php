...
class CreateGmsRateMasterDenroTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gms_rate_master_denro', function (Blueprint $table) {
               $table->increments('id');
    ...
    {
        Schema::dropIfExists('gms_rate_master_denro');
    }
}
