...
class CreateGmsRateCodeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gms_rate_code', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('scheme_rate_num')->nullable(); 
    ...
    {
        Schema::dropIfExists('gms_rate_code');
    }
}
