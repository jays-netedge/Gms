...
class CreateGmsRateMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gms_rate_master', function (Blueprint $table) {
            $table->increments('id'); 
            ...
            $table->decimal('extra_rate',7,2)->nullable();
    ...
    {
        Schema::dropIfExists('gms_rate_master');
    }
}
