...
class CreateGmsRateMasterSfDirHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gms_rate_master_sf_dir_history', function (Blueprint $table) {
               $table->increments('id');
               $table->integer('original_rate_id')->nullable();
    ...
    {
        Schema::dropIfExists('gms_rate_master_sf_dir_history');
    }
}
