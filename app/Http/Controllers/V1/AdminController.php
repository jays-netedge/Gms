...
class AdminController extends Controller
{
    ...
    {
        $viewPincode = DB::table('gms_pincode')
            ->join('gms_city', 'gms_pincode.city_code', '=', 'gms_city.city_code')
            ->select('gms_pincode.pincode_value', 'gms_pincode.service', 'gms_pincode.courier', 'gms_pincode.gold', 'gms_pincode.logistics', 'gms_pincode.regular', 'gms_pincode.topay',
                'gms_pincode.cod', 'gms_pincode.branch_id', 'gms_city.city_code', 'gms_city.city_name', 'gms_pincode.pin_status');
    ...
    {
        $getCustomer = DB::table('gms_customer')
            ->select('cust_code', 'cust_name', 'cust_type', 'cust_rep_office', 'cust_reach', 'approved_status');
